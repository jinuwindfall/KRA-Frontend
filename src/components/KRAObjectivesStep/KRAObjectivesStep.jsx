...
import styles from "./KRAObjectivesStep.module.css";
import { getFinalMark, getSectionMetrics, getSectionWeight } from "../../utils/ratingUtils";

/**
 * KRAObjectivesStep
 * Props:
 *   title   – section heading (e.g. "KRA Objectives")
 *   kras    – array of KRA objects from the API
 ...
 */
export default function KRAObjectivesStep({
  ...
  return (
    <div className={styles.card}>
      <h2>{title}</h2>
      <p className={styles.subText}>Enter scores based on defined objectives.</p>

      {kras.length === 0 && (
        <p className={styles.subText}>No KRA entries found for this staff yet.</p>
      )}
              ...
              <div className={styles.itemHeader}>
                <div>
                  <div className={styles.itemTitle}>
                    ...
                    <strong>{kra.title || `KRA Row ${kra.sl_no ?? index + 1}`}</strong>
                  </div>
                  {kra.description ? (
